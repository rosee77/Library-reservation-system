...
<table width="70%" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center" style="font-size:28px;">请填写要添加的Purchases信息</td>
    </tr>
</table>
<form action="save_purchases.php" method="post">
<table width="80%" border="0" align="center" cellpadding="5" cellspacing="10">
    <tr>
        <td width="40%" align="right">purid</td>
        <td width="60%" align="left"><input type="text" name="purid" size="40" style="height:25px"/></td>
    </tr>
    <tr>
        <td width="40%" align="right">cid</td>
        <td width="60%" align="left"><input type="text" name="cid" size="40" style="height:25px"/></td>
    </tr>
    <tr>
        <td width="40%" align="right">eid</td>
        <td width="60%" align="left"><input type="text" name="eid" size="40" style="height:25px"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="60%" align="left"><input type="text" name="qty" size="40" style="height:25px"/></td>
    </tr>
    <tr>
        <td width="40%" align="right">total_price</td>
        <td width="60%" align="left"><input type="text" name="total_price" size="40" style="height:25px"/></td>
    </tr>
</table>
