...
$sql = "INSERT INTO employees (eid,ename,city)
VALUES ('$eid','$ename','$city')";
...
if($result)
{
   ...
   echo "Employees信息添加成功,<a href='add_employees.php'>返回继续</a>";
}
else
{
   echo "Employees信息添加失败,<a href='add_employees.php'>请返回</a>";
}
?>
